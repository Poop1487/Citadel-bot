    ...
    try:
        with open(JSON_PATH, "r", encoding="utf-8") as file:
            ...
            if channel:
                ...
                await ctx.send(embed=discord.Embed(title="Ошибка", description="Не удалось найти канал с указанным ID.", color=discord.Color.red()), ephemeral=True)
    except (FileNotFoundError, json.JSONDecodeError, KeyError):
        await ctx.send(embed=discord.Embed(title="Ошибка", description="Файл логов не найден или содержит неверный формат.", color=discord.Color.red()), ephemeral=True)
...
async def xp(ctx, member: discord.Member = None):
    try:
        ...
        await ctx.respond(embed=discord.Embed(title="Ошибка", description="Произошла ошибка при получении XP.", color=discord.Color.red()), ephemeral=True)
...
async def addxp(ctx, amount: int, member: discord.Member):
    try:
        ...
        await ctx.respond(embed=discord.Embed(title="Ошибка", description="Произошла ошибка при добавлении XP.", color=discord.Color.red()), ephemeral=True)
...
async def remxp(ctx, amount: int, member: discord.Member):
    try:
        ...
        await ctx.respond(embed=discord.Embed(title="Ошибка", description="Произошла ошибка при удалении XP.", color=discord.Color.red()), ephemeral=True)
...
async def setxp(ctx, amount: int, member: discord.Member):
    try:
        ...
        await ctx.respond(embed=discord.Embed(title="Ошибка", description="Произошла ошибка при установке XP.", color=discord.Color.red()), ephemeral=True)
...
async def addxptogroup(ctx, amount: int, *, mentions: str):
    try:
        ...
        await ctx.respond(embed=discord.Embed(title="Ошибка", description="Произошла ошибка при добавлении XP группе.", color=discord.Color.red()), ephemeral=True)
...
async def remxpfromgroup(ctx, amount: int, *, mentions: str):
    try:
        ...
        await ctx.respond(embed=discord.Embed(title="Ошибка", description="Произошла ошибка при удалении XP у группы.", color=discord.Color.red()), ephemeral=True)
...
async def setxpforgroup(ctx, amount: int, *, mentions: str):
    try:
        ...
        await ctx.respond(embed=discord.Embed(title="Ошибка", description="Произошла ошибка при установке XP группе.", color=discord.Color.red()), ephemeral=True)
...
async def about_bot(ctx):
    try:
        ...
        await ctx.respond(embed=discord.Embed(title="Ошибка", description="Произошла ошибка при получении информации о боте.", color=discord.Color.red()), ephemeral=True)
...
""",
        ...
        await ctx.respond(embed=discord.Embed(title=f"Лазарет бот ответил на ваш вопрос: {question}", description=response.text[:2000], colour=0x48B5D6))
    except Exception as e:
